...
<div class="content">
  ...
  <div class="right-content">
    ...
    <div class="input-right"> <BR>
      ...
      <BR>
      никнейм
      <INPUT type="text" name="nikr" size="30">
      <BR>
      <BR>
      имя
    ...
    <div class="right-text-bottom">После того как Вы нажмёте кнопку “Зарегистрироваться” на ваш <BR>
      ...
      подтверждения регистрации.</div>
    <div class="right-submit">
      <ul class="submit-button-right">
        <li class="submit-right">Зарегестрироваться</li>
      </ul>
    </div>
  </div>
</div>
