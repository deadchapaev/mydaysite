...
////Закрыть всплывающие окна и слой затемнения
//    $('li.close, #fade').live('click', function () { //Закрыть при клике на слой вокруг окна...
//        $('#fade , .popup_block').fadeOut(function () {
//            $('#fade, a.close').remove();  //исчезают и окно и слой
//        });
//        return false;
//    });
